...
public class AddTeacherRequest extends StringRequest {
    ...
    public AddTeacherRequest(String teacherName, String teacherDOB, String teacherClass, String teacherImage, String teacherIntroduce, Response.Listener<String> listener) {
